...
TODO:
  1. Check if we should replace quadratic constraint cost with exponential ones
"""
...
# TODO: Toll station avoidance costs (multiple balls).
...
car_R_cost.add_cost(car_R_goal_py_cost, "x", 20.0)
# car_R_cost.add_cost(car_R_goal_psi_cost, "x", 10.0)
car_R_cost.add_cost(car_R_goal_vel_cost, "x", 5.0)
...
car_H_cost.add_cost(car_H_goal_py_cost, "x", 20.0)
# car_H_cost.add_cost(car_H_goal_psi_cost, "x", 10.0)
car_H_cost.add_cost(car_H_goal_vel_cost, "x", 5.0)
...
solver = ILQSolver(
    ...
    reference_deviation_weight=None, logger=None, visualizer=None,
...
if config.SAVE_TRAJ:
  np.save(
      os.path.join(LOG_DIRECTORY, FILE_NAME + '_xs.npy'),
