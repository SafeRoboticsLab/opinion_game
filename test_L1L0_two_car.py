...
GiNOD = NonlinearOpinionDynamicsTwoPlayer(
    x_indices_P1=np.array((0, 1, 2, 3)), x_indices_P2=np.array((4, 5, 6, 7)),
    z_indices_P1=np.array((8, 9)), z_indices_P2=np.array((10, 11)),
    att_indices_P1=np.array((12,)), att_indices_P2=np.array((13,)),
    z_P1_bias=0. * np.ones((2,)), z_P2_bias=0. * np.ones((2,)), T=TIME_RES,
    damping_opn=0.0, damping_att=0.5, rho=1.5, z_norm_thresh=5.0
)
...
planner = RHCPlanner(
    subgames, N_sim, jnt_sys, TwoCar_casadi, GiNOD, method='QMDPL1L0',
